...
const bulletPoints = [
  "Мгновенное создание комнаты и приглашение команды",
  "Живое голосование и история оценок в одном окне",
  "Понятный room UI для daily работы, а не для демо",
];
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col px-5 py-6 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between py-3">
          <div>
            ...
            <div className="text-sm text-slate-500">Collaborative estimation workspace</div>
          </div>
          ...
          <div className="grid w-full gap-10 lg:grid-cols-[minmax(0,1fr)_420px]">
            <section className="flex flex-col justify-center py-4 lg:py-10">
              <div className="inline-flex w-fit items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-2 text-sm font-medium text-slate-700 shadow-sm">
                ...
                {mode === "login" ? "Команда уже ждет в комнате" : "Подключайте команду за минуту"}
              </div>

              <div className="mt-6 max-w-2xl">
                <h1 className="text-balance text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
                  Planning Poker для команд, которым нужен чистый и быстрый workflow
                </h1>
                <p className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
                  Мы держим акцент на комнате, текущей задаче и реальном голосовании, чтобы
                  оценка была быстрой и без шума.
                </p>
              </div>
              ...
              <div className="mt-8 grid max-w-2xl gap-3 sm:grid-cols-3">
                {bulletPoints.map((item) => (
                  <div
                    className="rounded-2xl border border-slate-200 bg-white/85 p-4 text-sm text-slate-600 shadow-sm"
                    key={item}
                  >
              ...
              <div className="mt-10 hidden max-w-2xl rounded-[28px] border border-slate-200 bg-white/85 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] lg:block">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-semibold text-slate-900">Sprint estimation board</div>
                    <div className="text-sm text-slate-500">Realtime room preview</div>
                  </div>
                  ...
                  <div className="rounded-2xl bg-slate-50 p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {previewVotes.map((vote, index) => (
                        <div className="flex items-center justify-between" key={vote.label}>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-sm font-medium text-slate-900">{vote.label}</div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="mt-2 text-lg font-semibold text-slate-950">
                          Improve reconnect flow after socket drop
                        </div>
                      </div>
